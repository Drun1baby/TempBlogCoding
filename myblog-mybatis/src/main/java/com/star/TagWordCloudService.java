...
class TagWordCloudService {
     ...
     public static void main(String[] args) throws IOException {
         generate("D:\\test.txt", "D:\\java-practice\\Eliauk\\Eliauk\\src\\main\\resources\\static\\images\\cloud.png");
     }

     public static void generate(String wordFile, String pngOutputPath) throws IOException{
         double ratio = 1;
         // 共检索多少个词
...
//        20: bog
         ...
         wordFrequencies = frequencyFileLoader.load(getInputStream("D:\\test.txt"));
